    ...
    postprocessor: wallabyWebpack({
      ...
      module: {
        rules: [
          ...
          {
            test: /\.scss$|\.sass$/,
            loaders: [{ loader: 'raw-loader' }, { loader: 'sass-loader', options: { implementation: require('node-sass') } }]
          },
      ...
      resolve: {
        ...
        alias: Object.assign(libraries.reduce((result, project) => {
          ...
          {
            '@shared': path.resolve(wallaby.projectCacheDir, 'src/app/shared/'),
            '@core': path.resolve(wallaby.projectCacheDir, 'src/app/core/'),
            '@testing': path.resolve(wallaby.projectCacheDir, 'src/app/testing/'),
            '@utils': path.resolve(wallaby.projectCacheDir, 'src/app/utils/')
          })
      }
    }),
